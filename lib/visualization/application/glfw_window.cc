...
void keyCallback(GLFWwindow *window, int key, int /*scancode*/, int action, int /*mods*/)
{
  ...
  if (auto app = reinterpret_cast<Application *>(glfwGetWindowUserPointer(window)))
  {
    app->inputEvent(KeyInputEvent{key_code, key_action});
  }
}
...
{
  if (auto *app = reinterpret_cast<Application *>(glfwGetWindowUserPointer(window)))
    app->input_event(MouseButtonInputEvent{MouseButton::Unknown, MouseAction::Move,
...
void mouseButtonCallback(GLFWwindow *window, int button, int action, int /*mods*/)
{
  ...
  if (auto *app = reinterpret_cast<Application *>(glfwGetWindowUserPointer(window)))
  {
    ...
    app->inputEvent(MouseButtonInputEvent{translateMouseButton(button), mouseAction,
                                          static_cast<float>(xpos), static_cast<float>(ypos)});
  }
}
} // namespace

GLFWWindow::GLFWWindow(Application *platform, const IWindow::Properties &properties)
  : Window(properties)
{
  ...
  default:
    handle = glfwCreateWindow(properties.extent.width, properties.extent.height,
...
vk::SurfaceKHR GLFWWindow::createSurface(Instance &instance)
{
